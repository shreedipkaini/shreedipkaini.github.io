...
(function () {
  ...
  css.textContent = [
    ...
    /* Reveal animation */
".qv-wrap--pop {",
"  animation: qv-spiral-reveal 3s cubic-bezier(0.16, 1, 0.3, 1) forwards;",
"}",
".qv-wrap--pop iframe {",
"  animation: qv-bright-reveal 3s cubic-bezier(0.22, 1, 0.36, 1) forwards;",
"}",

"@keyframes qv-spiral-reveal {",
"  0% {",
"    opacity: 0;",
"    transform: scale(3.5) translateY(25%) translateX(10%) rotate(45deg);",
"  }",
"  20% {",
"    opacity: 1;",
"  }",
"  40% {",
"    transform: scale(2.2) translateY(10%) translateX(-5%) rotate(20deg);",
"  }",
"  65% {",
"    transform: scale(1.4) translateY(3%) translateX(3%) rotate(-8deg);",
"  }",
"  85% {",
"    transform: scale(1.05) translateY(-1%) translateX(0%) rotate(2deg);",
"  }",
"  100% {",
"    opacity: 1;",
...
"@keyframes qv-bright-reveal {",
"  0% {",
"    filter: brightness(0.6) saturate(0.75) contrast(1.3);",
"  }",
"  60% {",
"    filter: brightness(0.5) saturate(0.65) contrast(1.25);",
"  }",
"  100% {",

    ...
    function moveTerrain() { 
        ...
        if (changeDir === 0) {
            _direction = (_direction === Heli.Dir.DOWN) 
                ? Heli.Dir.UP : Heli.Dir.DOWN;
            len = (_direction === Heli.Dir.DOWN) 
...
var HELICOPTER = (function() {
    ...
    function startScreen() { 
        ...
        var t1 = "to go up, release to go down. (Tap on Phone)";
        ...
        ctx.fillText("press enter or click mouse to start (Tap on phone)", x + 5, y + 66);
        ctx.fillText("Shreedip Kaini's Website (shreedipkaini.com.np)", x + 5, y + 145);
    };                      
...
var KEY = {
    ...
    'SEMICOLON': 186, 'EQUALS_SIGN': 187, 'COMMA': 188, 'HYPHEN-MINUS': 189, 
